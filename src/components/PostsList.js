...
const API = 'http://restedblog.herokuapp.com/shriram/api/';
...
class PostsList extends Component {
  ...
  async generateMockData() {
    // let mockData =  ;
    // let newPosts = this.state.posts.push(mockData);
    this.setState({ loading: false, posts: await this.fetch('get', '/generateSampleData')});
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        <Typography variant="display1">Blog List</Typography>
